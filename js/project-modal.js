...
window.initProjectModal = function () {
    ...
    const PROJECTS = {
        ...
        'shell-risk': {
            ...
            category: 'AI · 风控 · 模型',
            title: '企空壳风险评级模型',
            period: '2025.03 – 2025.09 · 江苏省联合征信有限公司',
            background: '早期作为公司融资服务平台前置风控能力的一环服务于获客筛查，产品本身存在数据维度单一、模型规则固定缺少动态迭代能力，现借助公司引入相关数据资产的契机，优化重构空壳识别模型能力，同时将产品商业化。',
            highlights: [
                '<strong>规则策略调优</strong>：将以针对孤立企业的累加/累减评分机制，调整为基于企业关系图谱划分群组，通过组内企业特征数据计算群组关联指数，动态定义企业空壳风险等级阈值，完成从单体风险到网络化关联的评判。',
                '<strong>多源数据入模</strong>：1、引入社保、水电等多维经营数据，增强风险识别能力；2、根据当前规则评分项梳理特征工程；搜集空壳企业标注数据，配合数据工程师完成模型训练和评估，优化后模型准确率提升 31%。'
            ],
            tags: ['风险评级', '关系图谱', '特征工程', '数据入模', '商业化'],
            metrics: [
                { value: '31%', label: '准确率提升' },
                { value: '多源数据', label: '融合特征' },
                { value: '网络化', label: '关联评判' }
            ]
        },
        ...
        'ai-cs': {
            ...
            title: 'AI 客服 "苏晓惠"',
            period: '2024.11 – 2025.04 · 江苏省联合征信有限公司',
